...
use App\Filament\Operator\Resources\OrderResource\Pages;
use App\Filament\Operator\Resources\OrderResource\RelationManagers;
use App\Filament\Operator\Resources\OrderResource\RelationManagers\OrderLogsRelationManager;
use App\Filament\Operator\Resources\OrderResource\Widgets\OrderOverview;
use App\Models\City;
                    ...
                    ->schema([
                        Section::make()->schema([
                            TextInput::make('barcode')
                                ...
                                ->default(fn() => (string) random_int(100000000000, 999999999999)) // توليد بار كود تلقائي يتكون من أرقام
                                ->numeric() // التأكد من أن الحقل يتكون من أرقام فقط
